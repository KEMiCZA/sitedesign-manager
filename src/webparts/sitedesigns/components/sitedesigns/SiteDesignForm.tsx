...
export class SiteDesignForm extends React.Component<ISiteDesignFormProps & ISiteDesignFormApplicationStateToProps & ISiteDesignFormMapActionsToProps, ISiteDesignState> {
